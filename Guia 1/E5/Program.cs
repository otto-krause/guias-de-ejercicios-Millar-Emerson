        ...
        static void Main(string[] args)
        {
            ...
            while(decision!=0)
            {
                ...
                else
                {
                    if(decision==2)
                    {
                        Triangulo.EsEscaleno(lado1,lado2,lado3);
                    }
                    else
                    {
                        if(decision==3)
                        {
                            Triangulo.EsEquilatero(lado1,lado2,lado3);
                        }
                        else
                        {
                            if(decision==4)
                            {
                                Triangulo.esIsoceles(lado1,lado2,lado3);
                            }
                            else
                            {
                                if(decision==5)
                                {
                                    Triangulo.esTriangulorectangulo(lado1,lado2,lado3);
                                }
                            }
                        }
                    }
